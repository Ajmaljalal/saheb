Map english = {
  ...
  'advertPostDiscription':
      'Discription: (like color, used, new, model, size...etc.',
  ...
  'fillOutRequiredSectionsOther':
      'Please enter required information. Location, type of deal, title, description, and at least one picture is required.',
  ...
  'weakPassword':
      'Password is short and weak, it should be at least 8 characters.',
  'inUseEmail':
      'This email address is alreay in use, please try with a different one.',
  'userNotFound':
